...
<script>
    ...
    <div class="container col-10 col-sm-6 col-lg-4">
        ...
        <div class="text-center">
            <h2 class="text-capitalize my-5 text-lg">Staff Login</h2>
        </div>
        <form action="StaffLogin.php" method="POST" class="mx-3">
        ...
        <center class="mb-3">
                <a class="text-black-50" href="ForgetPassword.php" style="text-align:center; text-decoration: underline; ">Forgotten Password?</a>
        </center>


        <center class="mb-3">
                <a class="text-black-50" href="StaffRegister.php" style="text-align:center; text-decoration: underline; ">Create New Account</a>
        </center>
        </div>
