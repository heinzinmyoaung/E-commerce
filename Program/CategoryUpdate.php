...
if(isset($_POST['btnUpdate'])) 
{
	...
	{
		echo "<p>Something went wrong in CategoryUpdate : " . mysqli_error($conn) . "</p>";
	}
}
?>
<html>
...
<div class="container col-10 col-sm-6 col-lg-4">
    <div class="border rounded mt-5 bg-light">
        <div class="text-center">
            <h2 class="text-capitalize my-5 text-lg">Category Update</h2>
        </div>
        <form action="CategoryUpdate.php" method="POST" class="mx-3">
            ...
            <div class="col-lg-8 ">
                <input type="text" name="txtcategoryname" class="form-control" value="<?php echo $CategoryName ?>" id="inputName3" autocomplete="off" required>
            </div>
            </div>
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end mb-4">
                ...
                <a href="CategoryRegister.php" class="btn btn-primary">Cancel</a>
          </div>
        </form>
